...
\begin{minipage}[b]{0.5\textwidth}
    No differences found between statistically matched ELA groups:
    mass univariate paired t-tests for \texttt{ELA\textasciitilde tract} and
    per-bundle MANOVA for \texttt{tract\textasciitilde ELA} (both p>0.05,
    FDR corrected)
...
\begin{itemize}[nosep, leftmargin=*]
    ...
    distinct methods
    \begin{itemize}[nosep, leftmargin=*]
        \item statistical tests of group difference (paired t-test and MANOVA)
    ...
    \item Limitations
    \begin{itemize}[nosep, leftmargin=*]
        \item As a self-reported, cumulative measure of ELA, NLES may be
        inadequate, however, threat measurements APQ-CP and CPIC-threat also
